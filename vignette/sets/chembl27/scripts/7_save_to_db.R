...
scores <- readr:read_csv(paste0(staging_directory, "/data/chembl27_rdkit_ecfp4.scores.csv"))
...
pantry <- get_pantry('sea_chembl27')
#pantry %>% create_schema('sea_chembl27')
#pantry %>% set_schema('sea_chembl27')
