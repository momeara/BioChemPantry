...
schema <- "chembl27"
db_url <- "ftp://ftp.ebi.ac.uk/pub/databases/chembl/ChEMBLdb/latest/chembl_27_postgresql.tar.gz"
...
#dump_dir <- "/mnt/nfs/work/momeara/pantry_sets/chembl27/dump/postgres"

tar_fname <- paste0(dump_dir, "/", db_url %>% stringr::str_extract("[^/]+$"))
#tar_fname <- "/mnt/nfs/work/momeara/pantry_sets/chembl27/dump/postgres/chembl_27_postgresql.tar.gz"

dump_fname <- paste0(dump_dir, "/chembl_27/chembl_27_postgresql/chembl_27_postgresql.dmp")
