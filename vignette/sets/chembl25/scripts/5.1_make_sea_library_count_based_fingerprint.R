...
staging_directory <- BioChemPantry::get_staging_directory("chembl25")
...
make_library <- function(
	...
	description,
	verbose=TRUE){
	library_fname <- paste0(staging_directory, "/data/chembl25_", library_tag, ".sea")
	pack.library(
...
make_library(
	...
	fpcore_config="",
	description="ChEMBL25 by Uniprot Entry to Zinc ID with RDKit Atom Pair (AP) fingerprints")

make_library(
	library_tag="rdkit_avalon",
	fingerprint_type="rdkit_avalon",
	fpcore_config="",
	description="ChEMBL25 by Uniprot Entry to Zinc ID with Avalon Toolkit fingerprints")

make_library(
	library_tag="rdkit_ecfc",
	fingerprint_type="rdkit_ecfc",
	fpcore_config="",
	description="ChEMBL25 by Uniprot Entry to Zinc ID with Extended Connectivity Fingerprint (Path-based, Counts) fingerprints")

make_library(
	library_tag="rdkit_fcfc",
	fingerprint_type="rdkit_fcfc",
	fpcore_config="",
	description="ChEMBL25 by Uniprot Entry to Zinc ID with Extended Connectivity Fingerprint (Feature-based, Counts) fingerprints")

make_library(
	library_tag="rdkit_fcfp4",
	fingerprint_type="rdkit_fcfp",
	fpcore_config="[rdkit_fcfp]\ncircle_radius=2\n",
	description="ChEMBL25 by Uniprot Entry to Zinc ID with Extended Connectivity Fingerprint with diameter 4 (Feature-based, Hashed) fingerprints")

make_library(
	library_tag="rdkit_fcfp6",
	fingerprint_type="rdkit_fcfp",
	fpcore_config="[rdkit_fcfp]\ncircle_radius=3\n",
	description="ChEMBL25 by Uniprot Entry to Zinc ID with Extended Connectivity Fingerprint with diameter 6 (Feature-based, Hashed) fingerprints")

make_library(
	library_tag="rdkit_ecfp4",
	fingerprint_type="rdkit_ecfp",
	fpcore_config="[rdkit_ecfp]\ncircle_radius=2\n",
	description="ChEMBL25 by Uniprot Entry to Zinc ID with Extended Connectivity Fingerprint with diameter 4 (Hashed) fingerprints")

make_library(
	library_tag="rdkit_ecfp6",
	fingerprint_type="rdkit_ecfp",
	fpcore_config="[rdkit_ecfp]\ncircle_radius=3\n",
	description="ChEMBL25 by Uniprot Entry to Zinc ID with Extended Connectivity Fingerprint with diameter 6 (Hashed) fingerprints")

make_library(
	library_tag="rdkit_hashap",
	fingerprint_type="rdkit_hashap",
	fpcore_config="",
	description="ChEMBL25 by Uniprot Entry to Zinc ID with RDKit Atom Pair (AP, Hashed) fingerprints")

make_library(
	library_tag="rdkit_hashtt",
	fingerprint_type="rdkit_hashtt",
	fpcore_config="",
	description="ChEMBL25 by Uniprot Entry to Zinc ID with RDKit Topological Torsion (Hashed) fingerprints")

make_library(
	library_tag="rdkit_maccs",
	fingerprint_type="rdkit_maccs",
	fpcore_config="",
	description="ChEMBL25 by Uniprot Entry to Zinc ID with Molecular ACCess System keys")

make_library(
	library_tag="rdkit_path",
	fingerprint_type="rdkit_path",
	fpcore_config="",
	description="ChEMBL25 by Uniprot Entry to Zinc ID with RDKit Fingerprints (Path-based, Hashed)")

make_library(
	library_tag="rdkit_tt",
	fingerprint_type="rdkit_tt",
	fpcore_config="",
	description="ChEMBL25 by Uniprot Entry to Zinc ID with RDKit Topological Torsion Fingerprints")
