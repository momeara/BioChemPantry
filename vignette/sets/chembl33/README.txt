Curation of the ChEMBL33 database

Preparation of ChEMBL33 for chemoinformatic analysis requires
selecting targets, compounds, and activities between the them. Each
target may be composed of one or more components that each correspond
