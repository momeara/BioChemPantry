...
schema <- "chembl23"
db_url <- "ftp://ftp.ebi.ac.uk/pub/databases/chembl/ChEMBLdb/latest/chembl_23_postgresql.tar.gz"
...
#dump_dir <- "/mnt/nfs/work/momeara/pantry_sets/chembl23/dump/postgres"

tar_fname <- paste0(dump_dir, "/", db_url %>% stringr::str_extract("[^/]+$"))
#tar_fname <- "/mnt/nfs/work/momeara/pantry_sets/chembl23/dump/postgres/chembl_23_postgresql.tar.gz"

dump_fname <- paste0(dump_dir, "/chembl_23/chembl_23_postgresql/chembl_23_postgresql.dmp")
